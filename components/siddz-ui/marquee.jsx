...
export function TestimonialCard({
  ...
  return (
    <div
      className={`relative w-87.5 shrink-0 rounded-xl border border-zinc-800/60 bg-white p-5 backdrop-blur-sm transition-all ease-out duration-300 hover:border-zinc-700/60 hover:bg-zinc-900/60 ${className}`}
    >
